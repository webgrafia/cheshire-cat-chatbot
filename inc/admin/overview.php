...
function cheshirecat_overview_page()
{
    ...
    <div class="wrap">
        ...
        <p>
            <?php _e('You will need the following information from your Cheshire Cat AI setup:', 'cheshire-cat-chatbot'); ?>
        <ul style="list-style: disc; margin-left: 20px;">
            <li><?php _e('<strong>Cheshire Cat URL:</strong> The URL where your Cheshire Cat AI instance is running.', 'cheshire-cat-chatbot'); ?></li>
            <li><?php _e('<strong>Cheshire Cat Token:</strong> The API token for your Cheshire Cat AI instance.', 'cheshire-cat-chatbot'); ?></li>
        </ul>
        </p>
        <p>
            <?php _e('You can enter these details in the', 'cheshire-cat-chatbot'); ?> <a href="admin.php?page=cheshire-cat-configuration"><?php esc_html_e('Configuration', 'cheshire-cat-chatbot'); ?></a> <?php esc_html_e('section.', 'cheshire-cat-chatbot'); ?>
        </p>

        <h2><?php _e('Usage', 'cheshire-cat-chatbot'); ?></h2>

        <h3><?php _e('Displaying the Chat with the Shortcode', 'cheshire-cat-chatbot'); ?></h3>
        <p>
        ...
        <h3><?php _e('Enabling Global Chat', 'cheshire-cat-chatbot'); ?></h3>
        <p>
